            ...
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                                ...
                                <ul class="slides">
                                    <?php foreach ($gallery as $item) : ?>
                                        <li data-thumb="images/<?= $item->img; ?>">
                                            <div class="thumb-image"><img src="images/<?= $item->img; ?>" data-imagezoom="true" class="img-responsive" alt="<?= $item->img; ?>"/></div>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price" id="base-price" data-base="<?=ceil($product->price * $curr['value']); ?>"><?= $curr['symbol_left']; ?><?= ceil($product->price * $curr['value']); ?><?= $curr['symbol_right'] ?></h5>
                            <?php if ($product->old_price): ?>
                                <del><?= $curr['symbol_left']; ?><?= ceil($product->old_price * $curr['value']); ?><?= $curr['symbol_right'] ?></del>
                            <?php endif; ?>
                            <?= $product->content; ?>
                            <?php if($mods_color) : ?>
                            <div class="available">
                                <ul>
                                    <li>Color
                                        <select>
                                            ...
                                            <?php foreach ($mods_color as $color) : ?>
                                            <option data-title="<?=$color->title; ?>" data-price="<?=ceil($color->price * $curr['value']); ?>" value="<?=$color->id; ?>"><?=$color->title; ?></option>
                                            <?php endforeach; ?>
                                        </select></li>
                                ...
                                <div class="col-md-4 product-left p-left">
                                    <div class="product-main simpleCart_shelfItem">
                                        <a href="product/<?= $item['alias']; ?>" class="mask"><img
                                                    ...
                                                    src="images/<?= $item['img']; ?>" alt="<?= $item['title']; ?>"/></a>
                                        <div class="product-bottom">
                                            ...
                                            <h4>
                                                ...
                                                <?php if ($item['old_price']): ?>
                                                    <del><?= $curr['symbol_left']; ?><?= ceil($item['old_price'] * $curr['value']); ?><?= $curr['symbol_right'] ?></del>
                                                <?php endif; ?>
                                            </h4>
                                        </div>
                                        <?php if ($item['old_price']):
                                            $discaunt = ceil(100 - ($item['price'] * 100) / $item['old_price']);
                                            ?>
                                            <div class="srch">
                                                <span>-<?= $discaunt; ?>%</span>
                                            </div>
                ...
                <?php if ($recentlyViewed) : ?>
                    <div class="latestproducts">
                        ...
                        <div class="product-one" id="box" style="display: block;">
                            <h3>Недавно просмотренные :</h3>
                            <?php foreach ($recentlyViewed as $item): ?>
                                <div class="col-md-4 product-left p-left" id="box">
                                    <div class="product-main simpleCart_shelfItem">
                                        <a href="product/<?= $item['alias']; ?>" class="mask"><img
                                                    class="img-responsive zoom-img"
                                                    src="images/<?= $item['img']; ?>" alt="<?= $item['title']; ?>"/></a>
                        ...
                        <div class="product-one" id="box2">
                            <h3>Все просмотренные товары :</h3>
                            <?php foreach ($recentlyAllViewed as $item): ?>
                                <div class="col-md-4 product-left p-left" id="box">
                                    <div class="product-main simpleCart_shelfItem">
                                        <a href="product/<?= $item['alias']; ?>" class="mask"><img
                                                    class="img-responsive zoom-img"
                        ...
                        <button id="toggler">Все просмотренные</button>
                    </div>
                <?php endif; ?>
            </div>
