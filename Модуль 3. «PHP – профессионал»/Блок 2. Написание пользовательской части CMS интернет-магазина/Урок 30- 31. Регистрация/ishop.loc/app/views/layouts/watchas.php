                ...
                <div class="drop">
                    ...
                    <div class="btn-group">
                        <?php if (!empty($_SESSION['user'])) : ?>
                            <a class="dropdown-toggle" data-toggle="dropdown">Добро пожаловать, <?= h($_SESSION['user']['name']) ?><span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="user/logout">Выход</a></li>
                        </ul>
                        <?php else : ?>
                            <a class="user" href="user/signup">Регистрация</a>
                            <a class="user" href="user/login">Вход</a>
                        <?php endif; ?>
                    </div>
                    <!--<div class="btn-group">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <?php else : ?>
                    <a type="button" class="btn btn-primary" href="user/signup">Регистрация</a>
                    <a type="button" class="btn btn-primary" href="user/login">Вход</a>
                <?php endif; ?>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
